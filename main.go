...
func (t Training) TrainingInfo() InfoMessage {
	...
	return InfoMessage{
		...
		meanSpeed:    t.meanSpeed(),  // средняя скорость, с которой двигался пользователь
...
func (r Running) Calories() float64 {
	// вставьте ваш код ниже
	return (float64(CaloriesMeanSpeedMultiplier)*r.Training.meanSpeed() + CaloriesMeanSpeedShift) * r.Training.Weight / MInKm * r.Training.Duration.Hours() * MinInHours
}
...
func (w Walking) Calories() float64 {
	speedInMS := w.Training.meanSpeed() * KmHInMsec
	// вставьте ваш код ниже
	return (CaloriesWeightMultiplier*w.Training.Weight + (math.Pow(speedInMS, 2)/float64(w.Height))*CaloriesSpeedHeightMultiplier*w.Training.Weight) * w.Training.Duration.Hours() * MinInHours
}
